...
export class Emulator {
            ...
            case 0:
                switch (opcode) {
                    case 0x00E0:
                        ...
                        break;
                    case 0x00EE:
                        const lastAdress = this.stack.pop();
                        this.PC = lastAdress;
                }
                this.PC += 2;
                break;
    ...
    soundBeep() {
        if (this.isMuted || !this.audioContext || !this.audioBuffer)
            return;
        try {
...
document.addEventListener("keydown", (e) => {
    ...
    if (!Object.keys(emulator.keyStatus).includes(key))
        return;
    e.preventDefault();
    e.stopPropagation();
...
document.addEventListener("keyup", (e) => {
    ...
    if (emulator.waitingForKeyPress !== null && emulator.keyJustPressed === key) {
        ...
        emulator.V[emulator.waitingForKeyPress] = keyMap[key];
